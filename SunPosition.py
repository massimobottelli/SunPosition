...
# Position of the house (adjusted for two views)
...
myLat = 45.55074586769627
myLon = 9.1884181079518
...
def draw_sun_top(sun_angle):
    ...
    # Draw the text "S" on the sun path
    sun_position_x_S = sun_path_center_x - sun_path_radius * math.cos(math.radians(22))
    sun_position_y_S = sun_path_center_y_top - sun_path_radius * math.sin(math.radians(22))
    font = pygame.font.Font(None, 24)
    s_text = font.render("S", True, GRAY)  # Render "S" text
...
def track_and_update_sun():
    ...
    while True:
        ...
        # Draw the top view
        draw_house_top()
        sun_position_x, sun_position_y = draw_sun_top(current_azimuth - 180 + 22)
